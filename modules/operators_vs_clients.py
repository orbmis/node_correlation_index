...
def collate_operators_vs_clients(input_file='collated.json', json_output_file='operators_vs_clients.json', csv_output_file='operators_vs_clients.csv'):
    # Load the data
    ...
    with open(csv_output_file, mode='w', newline='') as csv_file:
        ...
        # Writing header
        header = ["Network Penetration", *next(iter(result_dict.values()))["clients"].keys()]
